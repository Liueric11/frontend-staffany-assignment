...
const ShiftForm = () => {
  ...
  const { startOfWeek } = useAppContext();
  ...
  useEffect(() => {
    if (currentData !== null) {
      ...
      setValue("date", startOfWeek);
      setValue("startTime", startTime.getTime());
      setValue("endTime", endTime.getTime());
    }
  }, [currentData, setValue, startOfWeek]);
